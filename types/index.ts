...
export type { SecureFederatedDatabase } from "./contracts/SecureFederatedDatabase";
export { SecureFederatedDatabase__factory } from "./factories/contracts/SecureFederatedDatabase__factory";
